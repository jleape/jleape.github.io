...
Remote | 2018 - present
- [Reti](https://reti.ai): founded startup advising adaptive planning and real options analysis
- InspiritAI: taught applied machine learning, including NLP, Object Detection, algorithmic bias
...
- Led $45M expansion of TransMilenio transit system with a novel diagnostic framework
- Automated generation of standardized transit data (GTFS) for formal and informal system
- Developed HyperionTransit, open-source software for transit planning and capacity analysis
...
- Created strategic plan to make 9-tower mixed-use development carbon neutral
- Supported demand model development in BuenosAires,Argentina,andVitoria,Brazil

## Education

### Massachusetts Institute of Technology
Cambridge, MA, USA | 2017 - 2020
...
- Thesis: [Winning the Housing Lottery in Rio de Janeiro: Curse or Cure?](https://dspace.mit.edu/handle/1721.1/127612)
